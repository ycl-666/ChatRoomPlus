                    ...
                    <div class="bbbug_scroll" ref="searchBox">
                        ...
                        <div class="bbbug_main_right_song_item" v-for="(item, index) in list" v-loading="item.loading">
                            <div class="bbug_main_right_song_pic">
                                <img :data="getStaticUrl(item.pic)" :src="getStaticUrl(item.pic)" class="xiaomi"
    ...
    export default {
        ...
        methods: {
            ...
            addSong(index) {
                ...
                that.$forceUpdate();
                //{week=36, mid=-4979, id=36360, pic=https://bbbug.hamm.cn//uploads/image/20210209/544b1474d1f7211fd05d0677e808b70f.jpg, singer=陈一发, name=童话镇, loading=true}
